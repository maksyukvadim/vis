...
TimeAxis.prototype.redraw = function () {
  ...
  //we have 3 group - append in 2 group axis timeline
  var g = Array.from(this.body.dom.container.getElementsByClassName('vis-group'));
  var g2 = g[g.length-2]
  g[g.length-3].classList.add('vis-events-row');
  g[g.length-1].classList.add('vis-state-row');
  g2.classList.add('vis-date-line-center');
  // determine the correct parent DOM element (depending on option orientation)
  var parent = (this.options.orientation.axis == 'top') ? this.body.dom.top : g2;
